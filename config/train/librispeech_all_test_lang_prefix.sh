...
--train_datasets librispeech/train-clean-360 librispeech/train-clean-100 librispeech/train-other-500  \
--eval_datasets librispeech/dev-clean librispeech/dev-other \